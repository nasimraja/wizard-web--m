                    ...
                    userNfts.length > 0 && userNfts.map((v,i) => {
                        if(parseInt(v) >= startRange && parseInt(v) <= endRange ){
                            return (
                                ...
                                <input type={"radio"} name={nftAddress} onChange={() => handleDepositChange(nftAddress,v)} /> ID: {v} <NftIcon nftid={v} nftAddress={nftAddress} />
                                </label>
                            )
                        }
