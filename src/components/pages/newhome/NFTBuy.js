...
import WizardBattlePass from '../../images/S3V3.jpg';
                    ...
                    <div className="row">
							<div className="col-lg-12">
                                <div className="nft-content">
                                    ...
                                    <p className='mb-3'>S3V3 NFT you qualify for the monthly rewards ceremony every single month.</p>
                                    {/* <h4>Limited-time NFTs</h4>
                                    <h5>NFT_BUY Available on Binance</h5> */}
                                </div>
                                <div className="admission-box">
                                    <div className="img-add">
                                        <img src={WizardBattlePass} />
                                    </div>
                                            ...
                                            <li>
                                                <div className="addlist-c-wrp">
                                                    <div className="addlist-c1">
                                                        <p>Welcome to the $S3V3 Friends</p>
                                                    </div>
                                            ...
                                            <li>
                                                <div className="addlist-c-wrp">
                                                    <div className="addlist-c4">
                                                        ...
                                                        <span>If you own S300, S3V2, and S3V3, you have free access to the Spartans Syndicate which goes over advanced strategies, exclusive content, private sales, pre-sales, and more. <br />
                                                        Only 300 are available of each collection and it is first come first serve.
                                                        </span>
                                                    </div>
